...
<template>
  <main>
    ...
    <div class="couverture">
      ...
      <div class="types">
        <CustomCheckBox v-for="(couverture,i) in insurance.couvertures" :key="couverture + i"  :label="couverture" :model-value="couverture.trim().toLowerCase()" name="couverture" :disable="true" :checked="true" />
      </div>
    </div>
  </main>
</template>
